...
{
	ClassDB::bind_method(D_METHOD("set_weaver_compositors", "weaver_compositors"), &WeaverView::set_weaver_compositors);
	ClassDB::bind_method(D_METHOD("get_weaver_compositors"), &WeaverView::get_weaver_compositors);
...
void WeaverView::set_weaver_compositors(const TypedArray<WeaverWebCompositor> &p_weaver_compositors)
{
	//Array effect_rids;
	...
	for (int i = 0; i < p_weaver_compositors.size(); i++)
	{
		...
		//
		// TODO: Hydrate all new WeaverWebCompositor with this WeaverView reference
...
TypedArray<WeaverWebCompositor> WeaverView::get_weaver_compositors() const
{
